...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-filename', type=str, default='/nfs/projects/llm_reason/data_analysis/c/data_flow_results_c_new_train.pkl')
    ...
    with open("data/data_analysis_c_train.json", 'w', encoding='utf8') as json_file:
        json_file.write(newdats_train)
    with open("data/data_analysis_c_val.json", 'w', encoding='utf8') as json_file:
