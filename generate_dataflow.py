...
output_filename = "predictions/dataflow_java_codellama.pkl"
...
adapter_path = 'dataflow_pretrained_java/checkpoint-720' # '/output' is not accepted
...
testdata = pickle.load(open("/nfs/dropbox/llm_reason/data_analysis/data_flow_results_java_test.pkl", "rb"))
allcode = []
predicted_data = []
